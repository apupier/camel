...
=== Deprecation of camel-reactive-executor-vertx and camel-threadpoolfactory-vertx

In preparation of upgrade to Vert.X 5, these 2 components are now deprecated and planned for removal after next LTS.
