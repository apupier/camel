...
public class Transcribe2ComponentVerifierExtension extends DefaultComponentVerifierExtension {

    public Transcribe2ComponentVerifierExtension() {
        this("aws2-transcribe");
    }

    public Transcribe2ComponentVerifierExtension(String scheme) {
        super(scheme);
    }
